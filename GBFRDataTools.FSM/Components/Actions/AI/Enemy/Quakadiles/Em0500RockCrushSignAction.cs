...
public class Em0500RockCrushSignAction : ShotAttackSignAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em0500RockCrushSignAction);

    public Em0500RockCrushSignAction()
    {
