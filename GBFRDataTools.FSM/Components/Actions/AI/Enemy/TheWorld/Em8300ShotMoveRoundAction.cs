...
public class Em8300ShotMoveRoundAction : ShotMoveStraightAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em8300ShotMoveRoundAction);

    public Em8300ShotMoveRoundAction()
    {
        VelocityBegin = 1f;
        VelocityEnd = -1f;
        MoveSecondMax = 2f;
