...
public class Em7700MoveWalkFrontAction : ActionComponent
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em7700MoveWalkFrontAction);
    ...
    public Em7700MoveWalkFrontAction()
    {
    }
}
