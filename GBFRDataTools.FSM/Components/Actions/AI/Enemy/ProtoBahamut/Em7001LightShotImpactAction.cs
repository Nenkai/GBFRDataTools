...
public class Em7001LightShotImpactAction : ShotAttackAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em7001LightShotImpactAction);

    public Em7001LightShotImpactAction()
    {
