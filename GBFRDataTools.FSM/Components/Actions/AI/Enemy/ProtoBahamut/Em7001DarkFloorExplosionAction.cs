...
public class Em7001DarkFloorExplosionAction : ShotAttackAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em7001DarkFloorExplosionAction);

    public Em7001DarkFloorExplosionAction()
    {
