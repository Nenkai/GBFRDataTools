...
public class Em7001DarkFloorShotAttackAction : ShotAttackAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em7001DarkFloorShotAttackAction);

    public Em7001DarkFloorShotAttackAction()
    {
