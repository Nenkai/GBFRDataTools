...
public class Em7001ExplodeShockWaveAttackAction : ShotAttackAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em7001ExplodeShockWaveAttackAction);

    public Em7001ExplodeShockWaveAttackAction()
    {
