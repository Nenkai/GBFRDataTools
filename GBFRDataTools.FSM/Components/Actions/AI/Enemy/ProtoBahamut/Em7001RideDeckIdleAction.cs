...
public class Em7001RideDeckIdleAction : ActionComponent
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em7001RideDeckIdleAction);
    ...
    public Em7001RideDeckIdleAction()
    {
    }
}
