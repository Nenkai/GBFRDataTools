...
public class Em8000SlashAttackShotAction : ShotAttackAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em8000SlashAttackShotAction);

    [JsonPropertyName("transitionSec_")]
