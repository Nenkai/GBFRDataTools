...
public class Em8000ExAttackFallSwordShotAttackSignAction : ShotAttackSignAction
{
    [JsonIgnore]
    public override string ComponentName => nameof(Em8000ExAttackFallSwordShotAttackSignAction);
    ...
    [JsonPropertyName("attackSignMoveWaitSec_")]
    public float AttackSignMoveWaitSec { get; set; } = 0.25f;

    public Em8000ExAttackFallSwordShotAttackSignAction()
    {
