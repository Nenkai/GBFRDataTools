...
public class AttackSignAction : ActionComponent
{
    [JsonIgnore]
    public override string ComponentName => nameof(AttackSignAction);
    ...
    public Vector4 LineEndOffset { get; set; } = Vector4.UnitW;
    ...
    [JsonPropertyName("isRectWallHitCheck")]
    public bool IsRectWallHitCheck { get; set; } = false;
