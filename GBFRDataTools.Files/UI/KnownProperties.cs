...
public class KnownProperties
{
    public static Dictionary<string, List<UIPropertyTypeDef>> ComponentList = new()
    {
        ...
        { "ControllerEmParam", ControllerEmParam.GetAllProperties() },
        ...
        { "ElementInfo", ElementInfo.GetAllProperties() },
        ...
        { "ItemIconStatus", ItemIconStatus.GetAllProperties() },
        { "ItemIconStatusSet", ItemIconStatusSet.GetAllProperties() },
        ...
        { "StatusIconSetter", StatusIconSetter.GetAllProperties() },
