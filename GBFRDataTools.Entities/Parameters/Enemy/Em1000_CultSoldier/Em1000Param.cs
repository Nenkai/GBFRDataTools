...
public class Em1000Param : EmCultSoldierBaseParam
{
    [JsonPropertyName("diveRequireSoldiers_")]
    public int DiveRequireSoldiers { get; set; } = 3;

    [JsonPropertyName("diveMaxDistance_")]
    public float DiveMaxDistance { get; set; } = 20f;
    ...
    public Em1000Param()
    {
        ...
        CounterAttackProbability = 75;
        MaxFormationSoldiers = 6;
        MaxFormationDeg = 170f;
        MinFormationDeg = 50f;
        InsideCameraDeg = 160f;
