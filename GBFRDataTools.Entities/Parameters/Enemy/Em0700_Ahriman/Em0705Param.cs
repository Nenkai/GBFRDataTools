...
public class Em0705Param : EmAhrimanSmallBaseParam
{
    ...
    [JsonPropertyName("poisonMistShotCoolTime_")]
    public float PoisonMistShotCoolTime { get; set; } = 5f;

    [JsonPropertyName("summonAppearTypeList_")]
    public BindingList<int> SummonAppearTypeList { get; set; } = []; // std::vector<int>

    [JsonPropertyName("modelColorChangeDebug_")]
    public bool ModelColorChangeDebug { get; set; } = false;

    [JsonPropertyName("modelColor_")]
    public Vector4 ModelColor { get; set; } = new Vector4(0.2f, 0.05f, 0.3f, 1f);
