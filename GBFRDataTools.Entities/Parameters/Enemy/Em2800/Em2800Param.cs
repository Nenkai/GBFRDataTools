...
namespace GBFRDataTools.Entities.Parameters.Enemy.Em2800;

public class Em2800Param : EnemyParameterInfo
{
    ...
    public float RegenerationHpRate { get; set; } = 0.05f;

    [JsonPropertyName("regenerationTime_")]
    public float RegenerationTime { get; set; } = 1.5f;

    [JsonPropertyName("homingAngle_")]
    public float HomingAngle { get; set; } = 2f;

    [JsonPropertyName("lowHpRate_")]
    public float LowHpRate { get; set; } = 2f;
    ...
    public Em2800Param()
    {
        ...
        AddReactionWeightRateMin = 1.8f;
        AddReactionWeightRateMax = 2.8f;
