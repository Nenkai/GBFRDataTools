...
public class Em0800Param : EmSeedParam
{
    [JsonPropertyName("blowBombBurnTime_")]
    public float BlowBombBurnTime { get; set; } = 5f;

    [JsonPropertyName("blowBombBurnRate_")]
    public float BlowBombBurnRate { get; set; } = 200f;
